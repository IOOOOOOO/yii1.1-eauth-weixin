...
abstract class EOAuth2Service extends EAuthServiceBase implements IAuthService {
	...
	protected function getCodeUrl($redirect_uri) {
		...
		return $this->providerOptions['authorize'] . '?client_id=' . $this->client_id . '&redirect_uri=' . urlencode($redirect_uri) . '&scope=' . $this->scope . '&response_type=code&appid='.$this->client_id;
	}
